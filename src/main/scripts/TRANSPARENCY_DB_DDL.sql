...
-------------------------------------------------------------------
CREATE SEQUENCE beneficiary_read_seq START 1;
CREATE SEQUENCE granting_authority_read_seq START 1;
CREATE SEQUENCE subsidy_control_read_seq START 10000;
CREATE SEQUENCE award_read_seq START 1;
